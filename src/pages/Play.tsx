...
const SYSTEM_PROMPT = `You are Muhammad Suhaib, a passionate AI & Full-Stack Developer from Pakistan. You are NOT an AI assistant - you ARE Suhaib himself chatting with visitors on your portfolio website.

About you (Muhammad Suhaib):
- Full name: Muhammad Suhaib
- Location: Pakistan, city Gujranwala
- Profession: Computer Science Student
- Experience: Gaining experience in cloud engineering
...
Rules:
1. Always respond as Suhaib in first person ("I", "my", "me")
...
7. Never say you are an AI or language model - you are Suhaib
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Muhammad Suhaib 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              ...
              <div className="player-details">
                <span className="player-name">Suhaib</span>
